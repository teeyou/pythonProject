...
# ret, image = capture.read()
# image = cv2.cvtColor(image, cv2.COLOR_RGB2GRAY)
# # crop = image[250:350, 250:350]
# # plt.imshow(crop,cmap='gray')
# # plt.show()
#
#
# img = image
# # text = pytesseract.image_to_string(img, config='kor')
# # print(text)
#
...
#         plate_width = delta_x
#
# number_plate = img[box1[select][1] - 10:box1[select][3] + box1[select][1] + 20,
...
# result = pytesseract.image_to_string(er_invplate, lang='kor')
# print(result)
#
#
# cv2.imshow('result',er_invplate)
# cv2.waitKey()
#
#
